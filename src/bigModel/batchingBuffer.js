...
class BatchingBuffer {
    constructor() {
        ...
        this.colors = new Uint8Array(MAX_VERTS * 4);
        this.quantizedPositions = new Uint16Array(MAX_VERTS * 3);
        this.encodedNormals = new Int8Array(MAX_VERTS * 2);
        this.pickIDs = bigIndicesSupported ? new Uint32Array(MAX_VERTS * 2) : new Uint16Array(MAX_VERTS * 2); // Per-object ID and per-triangle ID
