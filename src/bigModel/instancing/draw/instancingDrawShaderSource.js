...
function buildVertex(layer) {
    ...
    src.push("attribute vec4 modelMatrixCol3;");
   ...
   // src.push("mat4 modelMatrix = mat4(modelMatrixCol0, modelMatrixCol1, modelMatrixCol2, modelMatrixCol3);");
   ...
   // src.push("worldPosition = worldPosition * modelMatrix;");
    //src.push("worldPosition = vec4(dot(worldPosition, modelMatrixCol0), dot(worldPosition,modelMatrixCol1), dot(worldPosition,modelMatrixCol2), 1.0);");
